...
by value =
    VirtualDom.Styled.attribute "by" (Elm.Kernel.VirtualDom.noJavaScriptUri value)
...
from value =
    VirtualDom.Styled.attribute "from" (Elm.Kernel.VirtualDom.noJavaScriptUri value)
...
to value =
    VirtualDom.Styled.attribute "to" (Elm.Kernel.VirtualDom.noJavaScriptUri value)
...
values value =
    VirtualDom.Styled.attribute "values" (Elm.Kernel.VirtualDom.noJavaScriptUri value)
...
xlinkHref value =
    VirtualDom.Styled.attributeNS "http://www.w3.org/1999/xlink" "xlink:href" (Elm.Kernel.VirtualDom.noJavaScriptUri value)
